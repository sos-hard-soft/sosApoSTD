...
import com.soshs.sosapostd.entites.InsAdmSit;
import com.soshs.sosapostd.entites.InsAdmSitPK;
 ...
 */
@Stateless
@Path("com.soshs.sosapostd.entites.insadmsit")
public class InsAdmSitFacadeREST extends AbstractFacade<InsAdmSit> {
    ...
    private InsAdmSitPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.sosapostd.entites.InsAdmSitPK key = new com.soshs.sosapostd.entites.InsAdmSitPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.sosapostd.entites.InsAdmSitPK key = getPrimaryKey(id);
