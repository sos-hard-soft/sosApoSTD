...
import com.soshs.sosapostd.entites.IndDispenseElp;
import com.soshs.sosapostd.entites.IndDispenseElpPK;
 ...
 */
@Stateless
@Path("com.soshs.sosapostd.entites.inddispenseelp")
public class IndDispenseElpFacadeREST extends AbstractFacade<IndDispenseElp> {

    @PersistenceContext(unitName = "com.soshs_sosApoSTD_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    private IndDispenseElpPK getPrimaryKey(PathSegment pathSegment) {
        /*
         ...
         */
        com.soshs.sosapostd.entites.IndDispenseElpPK key = new com.soshs.sosapostd.entites.IndDispenseElpPK();
    ...
    public IndDispenseElpFacadeREST() {
        super(IndDispenseElp.class);
    }

    @POST
    @Override
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void create(IndDispenseElp entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") PathSegment id, IndDispenseElp entity) {
        super.edit(entity);
    }
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.sosapostd.entites.IndDispenseElpPK key = getPrimaryKey(id);
    ...
    public IndDispenseElp find(@PathParam("id") PathSegment id) {
        com.soshs.sosapostd.entites.IndDispenseElpPK key = getPrimaryKey(id);
    ...
    @Override
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<IndDispenseElp> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<IndDispenseElp> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
