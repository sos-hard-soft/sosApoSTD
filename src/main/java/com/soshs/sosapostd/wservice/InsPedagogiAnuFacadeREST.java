...
import com.soshs.sosapostd.entites.InsPedagogiAnu;
import com.soshs.sosapostd.entites.InsPedagogiAnuPK;
 ...
 */
@Stateless
@Path("com.soshs.sosapostd.entites.inspedagogianu")
public class InsPedagogiAnuFacadeREST extends AbstractFacade<InsPedagogiAnu> {
    ...
    private InsPedagogiAnuPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.sosapostd.entites.InsPedagogiAnuPK key = new com.soshs.sosapostd.entites.InsPedagogiAnuPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.sosapostd.entites.InsPedagogiAnuPK key = getPrimaryKey(id);
