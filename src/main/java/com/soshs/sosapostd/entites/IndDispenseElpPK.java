 ...
 */
@Embeddable
public class IndDispenseElpPK implements Serializable {
    ...
    public IndDispenseElpPK() {
    }

    public IndDispenseElpPK(String codAnu, int codInd, String codEtp, short codVrsVet, String codElp) {
        this.codAnu = codAnu;
        this.codInd = codInd;
        this.codEtp = codEtp;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof IndDispenseElpPK)) {
            return false;
        }
        IndDispenseElpPK other = (IndDispenseElpPK) object;
    ...
    public String toString() {
        return "com.soshs.sosapostd.entites.IndDispenseElpPK[ codAnu=" + codAnu + ", codInd=" + codInd + ", codEtp=" + codEtp + ", codVrsVet=" + codVrsVet + ", codElp=" + codElp + " ]";
    }
